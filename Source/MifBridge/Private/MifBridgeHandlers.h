...
#define MIF_DECL(Name) void H_##Name(const TSharedRef<FJsonObject>& In, const TSharedRef<FJsonObject>& Out)
	...
	MIF_DECL(set_niagara_emitter);
	MIF_DECL(add_niagara_emitter);
	MIF_DECL(remove_niagara_emitter);
	...
	MIF_DECL(set_niagara_user_parameter);
	...
	MIF_DECL(describe_ability_system);
