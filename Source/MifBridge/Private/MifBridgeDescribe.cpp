...
#define MIF_DESCRIBE_OWN_SUMMARY TEXT("name (aliases: endpoint, endpointName)")
		...
		static const TCHAR* const GMifDescNotes_create_material_instance[] = {
			...
			nullptr };
		static const TCHAR* const GMifDescKeys_create_datatable[] = {
			TEXT("path"), TEXT("rowStruct"), TEXT("struct"), nullptr };
		static const TCHAR* const GMifDescNotes_create_datatable[] = {
		...
		static const FMifDescribeRow GMifDescribeRows[] = {
			...
			{ TEXT("create_datatable"), GMifDescKeys_create_datatable, GMifDescNotes_create_datatable,
			  TEXT("path (must start with /Game/ - the table is named after the last segment), rowStruct (alias: struct) - a struct deriving from FTableRowBase, by name or object path"),
			  TEXT("MifBridgeUserTypes.cpp"), 328, nullptr },
