...
def main():
    ...
    print("  NOT EXERCISED: the vector-curve refusal itself. It sits after the data-model guard,")
    print("  and every AnimSequence here is cooked, so the guard always answers first. Reaching")
    print("  it needs an uncooked sequence - Curfew, not DDS2.")
