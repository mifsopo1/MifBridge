...
- [ ] **add_anim_notify / remove_anim_notify / add_anim_notify_track** (day)
...
- [ ] **extend add_anim_node to accept UAnimStateNodeBase (states + transitions)** (day)
...
- [ ] **attach_actor / detach_actor (+ attachParent + children on list_level_actors / get_level_actor)** (day)
...
- [ ] **extend list_components / add_component / remove_component / set_component_transform with actorPath (placed-actor instance components)** (day)
...
- [ ] **apply_spline_to_landscape (carve/paint terrain along a spline)** (hours)
...
- [ ] **add_anim_state and add_anim_transition (states and transitions inside an Anim State Machine)** (day)
...
- [ ] **extend add_sequence_track with root:true and cameraCut:true (root/master tracks and the camera cut track)** (day)
...
- [ ] **extend get_viewport_camera / set_viewport_camera with viewMode and showFlags** (day)
...
- [ ] **extend export_mesh with objectTypes / addLeafBones / armatureDeformOnly / boneAxis / bakeAnim** (day)
...
- [ ] **list_layers / modify_actor_layers / set_layer_visibility (the Outliner's Layers panel)** (day)
...
- [ ] **add_modifier / apply_modifier / remove_modifier (the write half of list_modifiers)** (day)
