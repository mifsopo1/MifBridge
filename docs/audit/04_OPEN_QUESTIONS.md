...
- `UK2Node_MathExpression` generic-spawn safety (Composite-derived, rebuilds an inner parsed graph) → read K2Node_MathExpression.cpp before taking it off the denylist.
