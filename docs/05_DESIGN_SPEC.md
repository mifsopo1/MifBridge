<!-- MIFBRIDGE-DEV-ONLY -- excluded from release zips by tools/make_release.py.
     The phase-by-phase build plan this plugin was written from. A record of how it was made,
     not of what it does - 00_ARCHITECTURE.md is the one a reader wants. Internal.
